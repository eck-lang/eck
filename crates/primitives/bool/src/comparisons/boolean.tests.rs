...
fn compares_boolean_payloads_for_equality_only() {
    let true_value = Value::new(crate::test_type_id(), true);
    let equal_true_value = Value::new(crate::test_type_id(), true);
    let false_value = Value::new(crate::test_type_id(), false);
