...
fn compares_integer_payloads() {
    let smaller = Value::new(crate::integer::integer16::test_type_id(), 4_i16);
    let equal_value = Value::new(crate::integer::integer16::test_type_id(), 4_i16);
    let larger = Value::new(crate::integer::integer16::test_type_id(), 7_i16);
...
/// Verifies total ordering at the signed 16-bit boundaries.
#[test]
...
fn rejects_non_integer_payloads() {
    let integer = Value::new(crate::integer::integer16::test_type_id(), 1_i16);
    let float = Value::new(crate::integer::integer16::test_type_id(), 1.0_f32);
