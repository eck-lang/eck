...
use self::{
    addition_integer128::{addition_integer, addition_mixed_integer},
    division_integer128::{division_integer, division_mixed_integer},
    multiplication_integer128::{multiplication_integer, multiplication_mixed_integer},
    power_integer128::{power_integer, power_mixed_integer},
    remainder_integer128::{remainder_integer, remainder_mixed_integer},
    subtraction_integer128::{subtraction_integer, subtraction_mixed_integer},
};
...
pub(crate) fn register_promotions(
    ...
    for narrower_id in narrower_ids {
        for (operator, execute) in [
            ...
            register_mixed_pair(registry, operator, *narrower_id, integer128_id, execute)?;
        }
    }
    Ok(())
}
