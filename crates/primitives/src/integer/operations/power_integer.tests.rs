...
fn raises_integers_to_non_negative_powers_and_rejects_invalid_exponents() {
    let base = Value::new(crate::integer::test_type_id(), 2_i64);
    let exponent = Value::new(crate::integer::test_type_id(), 10_i64);
    let negative = Value::new(crate::integer::test_type_id(), -1_i64);
    let maximum = Value::new(crate::integer::test_type_id(), i64::MAX);
    let two = Value::new(crate::integer::test_type_id(), 2_i64);
