...
use self::{
    addition_integer32::{addition_integer, addition_mixed_integer},
    division_integer32::{division_integer, division_mixed_integer},
    multiplication_integer32::{multiplication_integer, multiplication_mixed_integer},
    power_integer32::{power_integer, power_mixed_integer},
    remainder_integer32::{remainder_integer, remainder_mixed_integer},
    subtraction_integer32::{subtraction_integer, subtraction_mixed_integer},
};
...
pub(crate) fn register_promotions(
    ...
    for narrower_id in narrower_ids {
        for (operator, execute) in [
            ...
            register_mixed_pair(registry, operator, *narrower_id, integer32_id, execute)?;
        }
    }
    Ok(())
}
