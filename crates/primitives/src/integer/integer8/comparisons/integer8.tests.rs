...
fn compares_integer_payloads() {
    let smaller = Value::new(crate::integer::integer8::test_type_id(), 4_i8);
    let equal_value = Value::new(crate::integer::integer8::test_type_id(), 4_i8);
    let larger = Value::new(crate::integer::integer8::test_type_id(), 7_i8);
...
fn rejects_non_integer_payloads() {
    let integer = Value::new(crate::integer::integer8::test_type_id(), 1_i8);
    let float = Value::new(crate::integer::integer8::test_type_id(), 1.0_f32);
