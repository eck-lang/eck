...
fn compares_finite_double_values() {
    let smaller = Value::new(crate::double::test_type_id(), -1.25_f64);
    let larger = Value::new(crate::double::test_type_id(), 2.5_f64);
...
fn preserves_double_special_value_semantics() {
    let positive_zero = Value::new(crate::double::test_type_id(), 0.0_f64);
    let negative_zero = Value::new(crate::double::test_type_id(), -0.0_f64);
