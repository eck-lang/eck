...
fn compares_decimal_and_float_in_both_operand_orders() {
    ...
    let float = Value::new(crate::decimal::test_type_id(1), 2.5_f32);
...
fn preserves_precision_of_decimal_and_float_representations() {
    ...
    let float = Value::new(crate::decimal::test_type_id(1), 2.0_f32);
    let zero = Value::new(crate::decimal::test_type_id(0), Decimal::ZERO);
    let small_float = Value::new(crate::decimal::test_type_id(1), f32::MIN_POSITIVE);
...
fn preserves_ieee_special_value_semantics() {
    ...
    let nan = Value::new(crate::decimal::test_type_id(1), f32::NAN);
    let positive_infinity = Value::new(crate::decimal::test_type_id(1), f32::INFINITY);
