...
fn compares_decimal_and_double_in_both_operand_orders() {
    ...
    let double = Value::new(crate::test_type_id(1), 2.5_f64);
...
fn preserves_precision_of_decimal_and_double_representations() {
    ...
    let double = Value::new(crate::test_type_id(1), 2.0_f64);
    let zero = Value::new(crate::test_type_id(0), Decimal::ZERO);
    let small_double = Value::new(crate::test_type_id(1), 1e-29_f64);
...
fn preserves_ieee_special_value_semantics() {
    ...
    let nan = Value::new(crate::test_type_id(1), f64::NAN);
    let positive_infinity = Value::new(crate::test_type_id(1), f64::INFINITY);
    let negative_infinity = Value::new(crate::test_type_id(1), f64::NEG_INFINITY);
