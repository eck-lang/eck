use super::*;
use crate::primitives::decimal::value::get as get_decimal;
...
fn divides_decimal_and_double_in_both_orders() {
    ...
    let double = Value::new(crate::primitives::decimal::test_type_id(2), 2.0_f64);

    let decimal_left = division_decimal_double(&decimal, &double).unwrap();
    let double_left = division_decimal_double(
        &Value::new(crate::primitives::decimal::test_type_id(2), 5.0_f64),
        &Value::new(
            crate::primitives::decimal::test_type_id(1),
            Decimal::new(2, 0),
        ),
