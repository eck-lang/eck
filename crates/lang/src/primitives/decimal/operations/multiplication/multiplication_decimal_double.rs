...
use crate::primitives::decimal::operations::{checked_multiplication, decimal_double_operands};

/// Multiplies one decimal and one double, regardless of operand order.
pub(crate) fn multiplication_decimal_double(
    left_operand: &Value,
    right_operand: &Value,
...
#[cfg(test)]
#[path = "multiplication_decimal_double.tests.rs"]
mod tests;
