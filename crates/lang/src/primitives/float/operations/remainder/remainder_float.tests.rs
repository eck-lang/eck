...
fn calculates_float_remainder_and_rejects_zero() {
    let left_operand = Value::new(crate::primitives::float::test_type_id(), 10.5_f32);
    let right_operand = Value::new(crate::primitives::float::test_type_id(), 4.0_f32);
    let zero = Value::new(crate::primitives::float::test_type_id(), 0.0_f32);
