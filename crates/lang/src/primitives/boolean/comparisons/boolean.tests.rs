...
fn compares_boolean_payloads_for_equality_only() {
    let true_value = Value::new(crate::primitives::boolean::test_type_id(), true);
    let equal_true_value = Value::new(crate::primitives::boolean::test_type_id(), true);
    let false_value = Value::new(crate::primitives::boolean::test_type_id(), false);
...
fn rejects_non_boolean_payloads() {
    let boolean = Value::new(crate::primitives::boolean::test_type_id(), true);
    let integer = Value::new(crate::primitives::boolean::test_type_id(), 1_i64);
