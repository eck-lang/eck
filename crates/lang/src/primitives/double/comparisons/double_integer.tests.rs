...
fn compares_double_and_integer_in_both_operand_orders() {
    let double = Value::new(crate::primitives::double::test_type_id(), 2.5_f64);
    let integer = Value::new(crate::primitives::double::test_type_id(), 2_i64);
...
fn preserves_integer_precision_beyond_two_to_the_power_of_fifty_three() {
    let rounded_double = Value::new(
        crate::primitives::double::test_type_id(),
        9_007_199_254_740_992.0_f64,
    );
    let exact_integer = Value::new(
        crate::primitives::double::test_type_id(),
...
fn compares_signed_integer_boundaries_without_rounding() {
    let positive_boundary_double =
        Value::new(crate::primitives::double::test_type_id(), 2_f64.powi(63));
    let maximum_integer = Value::new(crate::primitives::double::test_type_id(), i64::MAX);
    let negative_boundary_double =
        Value::new(crate::primitives::double::test_type_id(), -2_f64.powi(63));
    let minimum_integer = Value::new(crate::primitives::double::test_type_id(), i64::MIN);
...
fn preserves_special_and_fractional_double_semantics() {
    let zero = Value::new(crate::primitives::double::test_type_id(), 0_i64);
    let negative_one = Value::new(crate::primitives::double::test_type_id(), -1_i64);
    let smallest_positive_double =
        Value::new(crate::primitives::double::test_type_id(), f64::from_bits(1));
    let negative_fraction = Value::new(crate::primitives::double::test_type_id(), -0.5_f64);
    let positive_infinity = Value::new(crate::primitives::double::test_type_id(), f64::INFINITY);
    let nan = Value::new(crate::primitives::double::test_type_id(), f64::NAN);
