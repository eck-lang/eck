...
fn calculates_double_remainder_and_rejects_zero() {
    let left_operand = Value::new(crate::primitives::double::test_type_id(), 10.5_f64);
    let right_operand = Value::new(crate::primitives::double::test_type_id(), 4.0_f64);
    let zero = Value::new(crate::primitives::double::test_type_id(), 0.0_f64);
