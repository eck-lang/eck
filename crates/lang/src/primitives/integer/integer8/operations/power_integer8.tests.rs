...
fn raises_integers_to_non_negative_powers_and_rejects_invalid_exponents() {
    let base = Value::new(crate::primitives::integer::integer8::test_type_id(), 2_i8);
    let exponent = Value::new(crate::primitives::integer::integer8::test_type_id(), 6_i8);
    let negative = Value::new(crate::primitives::integer::integer8::test_type_id(), -1_i8);
    let maximum = Value::new(
        crate::primitives::integer::integer8::test_type_id(),
        i8::MAX,
    );
    let two = Value::new(crate::primitives::integer::integer8::test_type_id(), 2_i8);
