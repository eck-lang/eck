...
fn divides_integers_and_rejects_zero_and_overflow() {
    let lhs = Value::new(crate::primitives::integer::integer8::test_type_id(), 43_i8);
    let rhs = Value::new(crate::primitives::integer::integer8::test_type_id(), 5_i8);
    let zero = Value::new(crate::primitives::integer::integer8::test_type_id(), 0_i8);
    let minimum = Value::new(
        crate::primitives::integer::integer8::test_type_id(),
        i8::MIN,
    );
    let negative_one = Value::new(crate::primitives::integer::integer8::test_type_id(), -1_i8);
...
/// Verifies context-aware division promotes the `MIN / -1` overflow to `int16`.
#[test]
fn promotes_overflowed_context_division_to_int16() {
    ...
    let operator = registry
        .resolve_binary_operator(BinaryOperator::Division, integer8_id, integer8_id)
        .unwrap();
