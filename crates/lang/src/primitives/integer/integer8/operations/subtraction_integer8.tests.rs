...
fn subtracts_integers_and_rejects_overflow() {
    let lhs = Value::new(crate::primitives::integer::integer8::test_type_id(), 15_i8);
    let rhs = Value::new(crate::primitives::integer::integer8::test_type_id(), 27_i8);
    let minimum = Value::new(
        crate::primitives::integer::integer8::test_type_id(),
        i8::MIN,
    );
    let one = Value::new(crate::primitives::integer::integer8::test_type_id(), 1_i8);
