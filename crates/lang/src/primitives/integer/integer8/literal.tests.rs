...
fn parses_signed_8_bit_integer_literals() {
    let minimum = parse("-128", crate::primitives::integer::integer8::test_type_id()).unwrap();
    let maximum = parse("127", crate::primitives::integer::integer8::test_type_id()).unwrap();
