...
fn extracts_integer_values_and_rejects_other_representations() {
    ...
    let float = Value::new(crate::primitives::integer::bigint::test_type_id(), 42.0_f32);
...
fn widens_narrower_operands_to_bigint_in_source_order() {
    ...
    let narrow8 = Value::new(crate::primitives::integer::integer8::test_type_id(), 7_i8);
    let narrow16 = Value::new(crate::primitives::integer::integer16::test_type_id(), 7_i16);
    let narrow32 = Value::new(crate::primitives::integer::integer32::test_type_id(), 7_i32);
    let narrow64 = Value::new(crate::primitives::integer::integer64::test_type_id(), 7_i64);
    let narrow128 = Value::new(
