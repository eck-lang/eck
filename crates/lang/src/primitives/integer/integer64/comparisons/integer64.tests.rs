...
fn compares_integer_payloads() {
    let smaller = Value::new(crate::primitives::integer::integer64::test_type_id(), 4_i64);
    let equal_value = Value::new(crate::primitives::integer::integer64::test_type_id(), 4_i64);
    let larger = Value::new(crate::primitives::integer::integer64::test_type_id(), 7_i64);
...
fn rejects_non_integer_payloads() {
    let integer = Value::new(crate::primitives::integer::integer64::test_type_id(), 1_i64);
    let float = Value::new(
        crate::primitives::integer::integer64::test_type_id(),
        1.0_f32,
    );
