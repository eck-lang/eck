...
use crate::semantic::{ConfigurationOverride, ConfigurationValue as CoreConfigurationValue};
use crate::syntax::{ConfigurationEntry, ConfigurationValue as SyntaxConfigurationValue};
